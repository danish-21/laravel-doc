                        ...
                        <tr>
                            <td class="bg_white email-section" style="width: 100%">
                                <div class="heading-section" style=" color:#0C0101; padding: 1.5em;">
                                    ...
                                    <p>We have received a request to log in to your X account. To protect the security of your account, we require a One-Time Password (OTP).</p>

                                    <p>Here is your <b> Email OTP Password  to log in: {{$otp->otp}}</b></p>
