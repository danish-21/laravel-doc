                        ...
                        <tr>
                            <td class="bg_white email-section" style="width: 100%">
                                <div class="heading-section" style=" color:#0C0101; padding: 1.5em;">
                                    ...
                                    <p> Welcome back to Neercare Agro!</p>

                                    <p> We have received a request to change to your password for Neercare Agro account. To protect the security of your account, we require a One-Time Password (OTP).</p>
